...
<div class="card">
<div class="card-header">
	<h3><i class=" fa fa-print"></i> Summary Report &nbsp;&nbsp;</h3>
</div>
<div class="card-body">
<div class="overflow" style="max-height: 80vh">	
<div class="row">
...
<iframe id="sheetframe" src="https://docs.google.com/spreadsheets/d/1cZHa2IyuzQuUpLtvgQAH_-TEi9flGsn0W41nOHb9-oY/htmlembed?gid=0&single=true&widget=true&headers=false"></iframe>
			...
			<div class="box bmh-75 box-bordered <?= $color[rand(1, 11)]; ?>">
			  <div class="box-group">
				<div class="box-group-icon">
				  ...
				  <div class="box-group-area">
					<h3 >TOTAL CODES GENERATED:  <span id="datafetch"></span></h3> </div>
				</div>
			  </div>
        </div>-->
