...
<!-- Logo Hotspotname -->
    <tr>
      <td style="text-align: center; font-size: 12px; font-weight:bold;"><?= $hotspotname; ?> (Store 1)</td>
    </tr>
    <tr>
      <td style="text-align: center; font-size: 14px; font-weight:bold; border-bottom: 1px black solid;"><?= date("Y-m-d h:i:sa") ?></td>
    </tr>
<!-- /  -->
    <tr>
      <td>
